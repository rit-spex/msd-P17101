...
The test engineer starts and stops a test with the VI (see Appendix~\ref{fig:VI-frontpanel}) from a computer connected to the test stand.
...
The VI may be stopped via the stop button on the front panel or by the satisfaction of a number of safety interlocks present within the block diagram.
