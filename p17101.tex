...
\end{equation}
 where $F$ is thrust, $v$ is flow velocity, $A$ is nozzle cross sectional area, and subscripts $e$ denotes parameters at the nozzle exit and $p_b$ denotes ambient backpressure.

% some calculations?
% explain influence of backpressure
