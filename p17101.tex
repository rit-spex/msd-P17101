...
\author{
  \IEEEauthorblockN{
    Dylan~Bruce\IEEEauthorrefmark{1},
    James~Gandek\IEEEauthorrefmark{2},
    Matt~Giuffre\IEEEauthorrefmark{3},
    Anthony~Higgins\IEEEauthorrefmark{4}, and
    Philip~Linden\IEEEauthorrefmark{5}
  }
  {\small
    \IEEEauthorblockA{\\
      \IEEEauthorrefmark{1}BS, Mechanical Engineering, Build Engineer
    }
    \IEEEauthorblockA{\\
      \IEEEauthorrefmark{2}BS, Mechanical Engineering, Project Manager
    }
    \IEEEauthorblockA{\\
      \IEEEauthorrefmark{3}BS, Mechanical Engineering, Test Engineer
    }
    \IEEEauthorblockA{\\
      \IEEEauthorrefmark{4}BS, Electrical Engineering, Design Engineer
    }
    \IEEEauthorblockA{\\
      \IEEEauthorrefmark{5}BS/ME, Mechanical Engineering, Design Engineer
    }
    \IEEEauthorblockA{\\
...
The impact of nozzle geometry, such as throat diameter, could be characterized empirically by testing many different nozzle profiles under the same conditions.
With proper instrumentation and documentation, relationships are likely to become apparent.
An experimental approach is much easier than an analytical one, especially since graphite stock material is relatively inexpensive, but ideally, nozzle design should be driven by theoretical performance based on analysis or simulation.
The ideal nozzle profile would choke the flow prior to the diverging section, and diverge along a spline rather than a conical section to minimize performance losses.
The team also recommends development of a robust theoretical model of the flow and heat transfer in this electrothermal system to inform future development.
...
\begin{figure}[!h]
  \includegraphics[angle=90,origin=center,height=.35\vsize,keepaspectratio]{figs/PCU_Schematic_No_AI_4_27_new.png}
